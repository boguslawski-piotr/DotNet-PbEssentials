...
namespace pbXForms
{
	public class PIButton : Xamarin.Forms.ContentView
	{
		...
		protected override void OnParentSet()
		{
			...
			if (BackgroundColor == Color.Default)
			{
				...
				while (parent != null)
				{
					if (Parent is VisualElement p && p.BackgroundColor != Color.Default)
					{
		...
		protected virtual void OnTapped(object parameter)
		{
	...
	public class PITextButton : PIButton
	{
		public PITextButton()
		{
			WidthRequest = -1;
