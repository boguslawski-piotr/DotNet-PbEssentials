...
namespace pbXForms
{
	public class ModalContentView : BaseContentView
	{
		...
		public override bool ViewCoversStatusBar => (Position == ModalViewsManager.ModalPosition.WholeView) && base.ViewCoversStatusBar;

		public event EventHandler OK;
		public event EventHandler Cancel;

		/// Indicates that the view is about to appear when displayed as modal.
